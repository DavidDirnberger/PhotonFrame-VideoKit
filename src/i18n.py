...
MESSAGES = {
    "en": {
        ...
        "help_pixelformat": "Pixel format (auto = keep best/target)",
        "help_audio_codec": "Audio codec (copy keeps source; e.g. aac, opus, mp3)",
        "help_audio_channel": "Audio channels (e.g. 2 for stereo). Triggers re-encode.",
        "help_keep_subtitles": "Keep subtitles as external files (when converting to containers that drop them)",
        "help_subtitle_format": "Subtitle format for external extraction (srt/ass/vtt)",
        "help_video_bitrate": "Video bitrate cap (VBV). Example: 4M, 8000k",
        ...
        "help_hdr_to_sdr": "Map HDR to SDR (BT.709) when detected",
        ...
        "preview_external_failed": "[preview skipped] external viewer failed: {err}",
        "preview_resize_failed": "[preview skipped] resize failed: {err}",
        "preview_stdout_not_tty": "[preview skipped] stdout is not a TTY (no terminal).",
        "preview_read_failed": "[preview skipped] read failed: {err}",
        "preview_iterm_failed": "[preview skipped] iTerm2 failed: {err}",
        "preview_chafa_failed": "[preview skipped] chafa failed: {err}",
        "preview_viu_failed": "[preview skipped] viu failed: {err}",
        "preview_open_external": "[i] No graphics-capable terminal detected – opening externally.",
        ...
        "unsuitable_audio_codec": "Audio codec {codec} unsuitable for {container} → use {sugg}",
        ...
        "pix_fmt_keep_prompt": "Keep the chosen/best pixel format?",
        "choose_pix_fmt": "Choose pixel format",
        "audio_codec_keep_prompt": "Keep original audio codec?",
        "choose_audio_codec": "Choose audio codec",
        "choose_audio_channels": "Choose target audio channels (current: {ch})",
        "video_bitrate_keep_prompt": "Keep current video bitrate (no cap)?",
        "choose_video_bitrate": "Choose video bitrate cap",
        "video_bitrate_custom_prompt": "Enter custom video bitrate (e.g. 4M or 8000k)",
        "invalid_video_bitrate": "Invalid video bitrate.",
        "video_bitrate_requires_reencode": "Video bitrate cap requires re-encoding; ignored.",
        "keep_subtitles_prompt": "MP4 may drop embedded subtitles. Export all subtitles as external files?",
        "subtitles_will_be_lost": "Subtitles detected, but the target container may not keep them. Use --keep-subtitles to export.",
        ...
        "hdr_to_sdr_prompt": "HDR content detected. Map to SDR (BT.709)?",
        "hdr_to_sdr_filters_missing": "HDR detected but required filters (zscale/tonemap) are missing. Skipping SDR mapping.",
        "hdr_to_sdr_requires_reencode": "HDR→SDR mapping requires re-encoding; switching codec to {codec}.",
        ...
        "pix_fmt_requires_reencode": "Pixel format change requires re-encoding; switching codec to {codec}.",
        "pix_fmt_not_allowed": "Pixel format {pix_fmt} is not allowed in {container}; using {sugg}.",
        # Compress
        ...
        "extracting_subtitle_failed": "Subtitle extraction failed",
    ...
    "de": {
        ...
        "help_pixelformat": "Pixelformat (auto = bestes/Ziel-Format beibehalten)",
        "help_audio_codec": "Audio-Codec (copy behält Quelle; z. B. aac, opus, mp3)",
        "help_audio_channel": "Audio-Kanaele (z. B. 2 fuer Stereo). Erfordert Neukodierung.",
        "help_keep_subtitles": "Untertitel als externe Dateien mitfuehren (bei Containern ohne Untertitel)",
        "help_subtitle_format": "Untertitel-Format fuer externe Extraktion (srt/ass/vtt)",
        "help_video_bitrate": "Video-Bitrate-Cap (VBV). Beispiel: 4M, 8000k",
        ...
        "help_hdr_to_sdr": "HDR auf SDR (BT.709) mappen, falls erkannt",
        ...
        "preview_external_failed": "[Vorschau übersprungen] Externer Viewer fehlgeschlagen: {err}",
        "preview_resize_failed": "[Vorschau übersprungen] Verkleinerung fehlgeschlagen: {err}",
        "preview_stdout_not_tty": "[Vorschau übersprungen] stdout ist kein TTY (kein Terminal).",
        "preview_read_failed": "[Vorschau übersprungen] Lesen fehlgeschlagen: {err}",
        "preview_iterm_failed": "[Vorschau übersprungen] iTerm2 fehlgeschlagen: {err}",
        "preview_chafa_failed": "[Vorschau übersprungen] chafa fehlgeschlagen: {err}",
        "preview_viu_failed": "[Vorschau übersprungen] viu fehlgeschlagen: {err}",
        "preview_open_external": "[i] Kein grafikfähiges Terminal erkannt – öffne extern.",
        ...
        "unsuitable_audio_codec": "Audio-Codec {codec} ungeeignet für {container} → nehme {sugg}",
        ...
        "pix_fmt_keep_prompt": "Pixelformat beibehalten (gewählt/bestmöglich)?",
        "choose_pix_fmt": "Pixelformat wählen",
        "audio_codec_keep_prompt": "Audio-Codec beibehalten?",
        "choose_audio_codec": "Audio-Codec wählen",
        "choose_audio_channels": "Ziel-Audiokanäle wählen (aktuell: {ch})",
        "video_bitrate_keep_prompt": "Video-Bitrate beibehalten (kein Cap)?",
        "choose_video_bitrate": "Video-Bitrate-Cap wählen",
        "video_bitrate_custom_prompt": "Benutzerdefinierte Video-Bitrate eingeben (z. B. 4M oder 8000k)",
        "invalid_video_bitrate": "Ungültige Video-Bitrate.",
        "video_bitrate_requires_reencode": "Video-Bitrate-Cap erfordert Re-Encode; ignoriert.",
        "keep_subtitles_prompt": "MP4 kann eingebettete Untertitel verlieren. Alle Untertitel extern mitfuehren?",
        "subtitles_will_be_lost": "Untertitel gefunden, aber der Zielcontainer haelt sie evtl. nicht. Nutze --keep-subtitles zum Export.",
        ...
        "hdr_to_sdr_prompt": "HDR-Inhalt erkannt. Auf SDR (BT.709) mappen?",
        "hdr_to_sdr_filters_missing": "HDR erkannt, aber benötigte Filter (zscale/tonemap) fehlen. SDR-Mapping wird übersprungen.",
        "hdr_to_sdr_requires_reencode": "HDR→SDR-Mapping erfordert Neukodierung; Codec wird auf {codec} gesetzt.",
        ...
        "pix_fmt_requires_reencode": "Pixelformat-Änderung erfordert Neukodierung; Codec wird auf {codec} gesetzt.",
        "pix_fmt_not_allowed": "Pixelformat {pix_fmt} ist in {container} nicht erlaubt; verwende {sugg}.",
        # Compress
        ...
        "extracting_subtitle_failed": "Untertitelextraktion fehlgeschlagen",
